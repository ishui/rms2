namespace RmsPM.DAL.CommonWorkFlowDAL
{
    ...
    public class TCheckPaymentModel
    {
        private string _AcceptAccounts;
        private string _AcceptBank;
        private decimal _AcceptMoney;
        private string _AcceptMoneyType;
        private string _AcceptUnit;
        private string _Flag;
        private string _PaymentAccounts;
        private string _PaymentBank;
        private string _PaymentCodition;
        private decimal _PaymentMoney;
        private string _PaymentMoneyType;
        private string _PaymentRemark;
        private string _PaymentTicketDate;
        private string _PaymentTicketMark;
        private string _PaymentUnit;
        private string _Remark;
        private string _State;
        private string _TCheckPaymentcode;
